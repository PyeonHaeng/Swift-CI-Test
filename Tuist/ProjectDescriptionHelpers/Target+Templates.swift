  ...
  static func app(
    ...
    let targets = [
      Target(
        ...
        platform: .iOS,
        product: .app,
        bundleId: "\(ProjectEnvironment.default.prefixBundleID).app",
      ...
      Target(
        ...
        platform: .iOS,
        product: .unitTests,
        bundleId: "\(ProjectEnvironment.default.prefixBundleID).appTests",
        deploymentTarget: ProjectEnvironment.default.deploymentTarget,
        infoPlist: .default,
        sources: .unitTests,
        scripts: [.swiftFormat, .swiftLint],
      ...
      Target(
        ...
        platform: .iOS,
        product: .uiTests,
        bundleId: "\(ProjectEnvironment.default.prefixBundleID).appUITests",
        deploymentTarget: ProjectEnvironment.default.deploymentTarget,
        infoPlist: .default,
        sources: .uiTests,
        scripts: [.swiftFormat, .swiftLint],
  ...
  static func feature(
    ...
    var projectTargets: [Target] = [
      Target(name: feature.targetName,
             platform: .iOS,
             product: .framework,
             bundleId: "\(ProjectEnvironment.default.prefixBundleID).\(feature.targetName.lowercased())",
    ...
    if additionalTargets.contains(.unitTest) {
      projectTargets.append(Target(name: "\(feature.targetName)Tests",
                                   platform: .iOS,
                                   product: .unitTests,
                                   bundleId: "\(ProjectEnvironment.default.prefixBundleID).\(feature.targetName.lowercased())Tests",
                                   deploymentTarget: deploymentTarget,
                                   infoPlist: .default,
                                   sources: .unitTests,
                                   scripts: [.swiftFormat, .swiftLint],
    ...
    if additionalTargets.contains(.uiTest) {
      projectTargets.append(Target(name: "\(feature.targetName)UITests",
                                   platform: .iOS,
                                   product: .uiTests,
                                   bundleId: "\(ProjectEnvironment.default.prefixBundleID).\(feature.targetName.lowercased())UITests",
                                   deploymentTarget: deploymentTarget,
                                   infoPlist: .default,
                                   sources: .unitTests,
                                   scripts: [.swiftFormat, .swiftLint],
